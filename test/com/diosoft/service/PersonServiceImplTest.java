...
public class PersonServiceImplTest {
    ...
    public void getInnerAndOuterPersons() throws IOException, JAXBException {
        ...
        expectedMap.put("Inner",expectedInner);
        expectedMap.put("Outer",expectedOuter);

        PersonOperations mock = mock(PersonOperations.class);
        PersonService personService = new PersonServiceImpl(mock);

        when(mock.getInnerAndOuterPersons(persons1, persons2)).thenReturn(expectedMap);

        Map<String, List<Person>> actualMap = personService.getInnerAndOuterPersons(persons1, persons2);

        List<Person> actaulInner = actualMap.get("Inner");
        List<Person> actaulOuter = actualMap.get("Outer");
        ...
        verify(mock,times(1)).getInnerAndOuterPersons(persons1, persons2);

    }

    @Test
    public void getUniquePersonsOfSameAge() throws IOException, JAXBException {
        Person[] personsArray1 = {person11,person14,person17,person20};
        Person[] personsArray2 = {person12,person15,person26,person29};
        ...
        when(mock.getUniquePersonsOfSameAge(31, persons1, persons2)).thenReturn(expected);

        List<Person> resultList = personService.getUniquePersonsOfSameAge(31,persons1,persons2);
        ...
        verify(mock,times(1)).getUniquePersonsOfSameAge(31, persons1, persons2);
    }

    @Test
    public void getInnerAndOuterPersonsMore2() throws IOException, JAXBException {
        Person[] personsArray1 = {person11,person14,person17,person20};
        Person[] personsArray2 = {person12,person15,person26,person29};
        ...
        when(mock.getInnerAndOuterPersons(persons)).thenReturn(expectedMap);

        Map<String, List<Person>> resultMap = personService.getInnerAndOuterPersons(persons);
        ...
        verify(mock,times(1)).getInnerAndOuterPersons(persons);
    }

    @Test
    public void getUniquePersonsOfSameAgeMore2() throws IOException, JAXBException {
        Person[] personsArray1 = {person11,person14,person17,person20};
        Person[] personsArray2 = {person12,person15,person26,person29};
        Person[] personsArray3 = {person27,person30,person32,person35};
        Person[] expectedArray = {person17,person20};
        ...
        when(mock.getUniquePersonsOfSameAge(31, persons)).thenReturn(expected);

        List<Person> resultList = personService.getUniquePersonsOfSameAge(31,persons);
        ...
        verify(mock,times(1)).getUniquePersonsOfSameAge(31, persons);
